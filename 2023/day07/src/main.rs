...
impl Hand {
    ...
    fn get_hand_type_part2(groups: &HashMap<char, Vec<char>>) -> HandType {
           let mut ht = HandType::FiveOfKind;
           ht
    }
    ...
    fn new(cards: &str, part2: bool) -> Self {
        ...
        Hand { combo: String::from(cards), hand_type: ht, groups: groups, part2: part2 }
    }
}
...
impl Round {
    fn new(line: &str, part2: bool) -> Self {
        ...
        Round { hand: Hand::new(splits[0], false), bid: splits[1].parse().unwrap() }
    }
}
